	...
	<div class="container">
		<div class="frame">
			...
			<form class="form-signin" action="./j_security_check" method="post"
				name="form">
				<label for="pseudo">Pseudo</label> <input class="form-styling"
					type="text" name="j_username" placeholder="Tapez votre pseudo"
					required /> <label for="password">Mot de passe</label> <input
					class="form-styling" type="password" name="j_password"
